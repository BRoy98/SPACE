...
package com.hometsolutions.space.Widgets;
...
public class LoadingButton extends View {
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        if(attrs != null){
            ...
            mColorPrimary = ta.getInt(R.styleable.LoadingButton_btn_Color,defaultColor);
            String text = ta.getString(R.styleable.LoadingButton_btn_text);
            mText = text == null ? "" : text;
            mTextColor = ta.getColor(R.styleable.LoadingButton_btn_textColor, Color.WHITE);
            resetAfterFailed = ta.getBoolean(R.styleable.LoadingButton_btn_resetAfterFailed,true);
            mRippleColor = ta.getColor(R.styleable.LoadingButton_btn_rippleColor, Color.BLACK);
            ta.recycle();
        }
    ...
    public void setButtonPrimaryColor(int color) {
