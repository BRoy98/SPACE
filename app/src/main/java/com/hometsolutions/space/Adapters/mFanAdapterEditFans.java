...
import com.hometsolutions.space.Fragments.addFanFragment;
import com.hometsolutions.space.Utils.DatabaseHelper;
import com.hometsolutions.space.R;

/**
 * Created by Bishwajyoti Roy on 11/4/2016.
 */

public class mFanAdapterEditFans extends RecyclerView.Adapter<mFanAdapterEditFans.mViewHolder> {

    private Context context;
    private String[] data;
    private LayoutInflater inflator;
    private EditComponentsActivity editComponentsActivity;
    private addFanFragment addFanFragment;
    ...
    public mFanAdapterEditFans(Context context, String[] data, EditComponentsActivity editComponentsActivity, addFanFragment addFanFragment) {
        this.context = context;
        this.data = data;
        inflator = LayoutInflater.from(context);
        this.editComponentsActivity = editComponentsActivity;
        this.addFanFragment = addFanFragment;
    ...
    public int getItemCount() {
        return databaseHelper.FAN_getCount(editComponentsActivity.roomID);
    }
            ...
            cardCardView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    MaterialDialog dialog = new MaterialDialog.Builder(editComponentsActivity)
                            .title(addFanFragment.fanNames[id] + " Details")
                    ...
                    DetailsName.setText(addFanFragment.fanNames[id]);
                    DetailsRoom.setText(editComponentsActivity.roomName);
                    DetailsDate.setText(databaseHelper.FAN_getTime(addFanFragment.fanNames[id]));
                    DetailsID.setText(databaseHelper.FAN_getID(addFanFragment.fanNames[id]));
                }
            });
                    ...
                    new MaterialDialog.Builder(editComponentsActivity)
                            ...
                            .itemsCallback(new MaterialDialog.ListCallback() {
                                ...
                                public void onSelection(MaterialDialog dialog, View view, int which, CharSequence text) {
                                    switch (which) {
                                        case 0:
                                            String fanName_ = addFanFragment.fanNames[id];
                                            new MaterialDialog.Builder(editComponentsActivity)
                                                    .title("Rename " + fanName_)
                                                    ...
                                                    .positiveText("Rename")
                                                    .negativeText("Cancel")
                                                    .input("Eg.: My Room", fanName_, false, new MaterialDialog.InputCallback() {
                                                        @Override
                                                        public void onInput(@NonNull MaterialDialog dialog, CharSequence input) {
                                                            try {
                                                                databaseHelper.FAN_rename(addFanFragment.fanNames[id], input.toString());
                                                            } catch (Exception e) {
                                                                e.printStackTrace();
                                                            }
                                                            addFanFragment.loadAdapter(editComponentsActivity.roomID);
                                                        }
                                                    }).show();
                                            break;
                                        case 1:
                                            String fanName = addFanFragment.fanNames[id];
                                            new MaterialDialog.Builder(editComponentsActivity)
                                                    .title("Delete " + fanName + "?")
                                                    ...
                                                    .onAny(new MaterialDialog.SingleButtonCallback() {
                                                        ...
                                                        public void onClick(@NonNull MaterialDialog dialog, @NonNull DialogAction which) {
                                                            ...
                                                            switch (which.toString()) {
                                                                case "POSITIVE":
                                                                    try {
                                                                        databaseHelper.FAN_delete(addFanFragment.fanNames[id]);
                                                                    } catch (Exception e) {
                                                                        e.printStackTrace();
                                                                    }
                                                                    addFanFragment.loadAdapter(editComponentsActivity.roomID);
