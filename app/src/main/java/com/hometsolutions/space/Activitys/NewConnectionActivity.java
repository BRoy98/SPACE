...
import com.hometsolutions.space.Wizerd.Model.ConnectionWizardModel;
...
public class NewConnectionActivity extends AppCompatActivity implements
    ...
    private AbstractWizardModel mWizardModel = new ConnectionWizardModel(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("New Connection Wizerd");
